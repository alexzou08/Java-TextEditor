...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> tokensByWords = getTokens(pattern);
	    return tokensByWords.size();
	}
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		String pattern = "[^!.?]+";
		List<String> tokensBySentences = getTokens(pattern);
	    return tokensBySentences.size();
	}
	...
	public int getNumSyllables()
	{
		...
		for(int i = 0; i < tokensByWords.size(); i++) {
			String tokensLowerCase = tokensByWords.get(i).toLowerCase();
			numOfSyllables += countSyllables(tokensLowerCase);
		}
