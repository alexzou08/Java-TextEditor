	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int i = 0; i < trials; i++) {
				Document doc = new BasicDocument(input);
				doc.getFleschScore();
			}
			long basicTime = System.nanoTime() - basicStartTime;
			System.out.print(1.0 * basicTime / 1000000000 + "\t");
			...
			long effTime = System.nanoTime() - effStartTime;
			System.out.print(1.0 * effTime / 1000000000 + "\n");
		}
